...
{
    Texture2D inputTexture = ResourceDescriptorHeap[SRVIndices.Idx0];
...
{
    Texture2D inputTexture0 = ResourceDescriptorHeap[SRVIndices.Idx0];
    Texture2D inputTexture1 = ResourceDescriptorHeap[SRVIndices.Idx1];
